...
if direction == "left":
    ...
    ./づ~ ♡
            ...
            print(
                "Oh no! You chose Chanel? Now you are in a store full of poorly made overpriced bags! \n Better luck next time!!!")
        else:
            print("Gorl, learn how to spell your designers! Better luck next time.")
    else:
        print(
            "Oh no! You decided to walk and a kid threw his icecream at you. \n Look at that ice cream all over your Loro Piana outfit. \n Better luck next time. Try again!")
else:
    print("Oof! You fell into a hole of cheap Louis Vuitton bags. Sorry! Better luck next time!")

print ("Thank you for playing! It was a true pleasure to have you. Have a great day!!!")
